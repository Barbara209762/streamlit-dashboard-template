...
st.subheader('courbes des Ventes quotidiennes')
...
st.subheader('b/ Montant moyen par transaction par magasin')
...
st.subheader(' TABLEAU des Ventes totales et nombre de transactions par magasin')
...
st.header('3.Analyse des catégories de produits')

# Histogramme des quantités vendues par catégorie
st.subheader('A/ HISTOGRAMMES des Quantités vendues par catégorie')
...
st.subheader('2/ Montants des ventes par catégorie et magasin')
...
st.subheader('4.Top 5 des produits les plus vendus par catégorie')
